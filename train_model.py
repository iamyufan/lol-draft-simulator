...
def main():
    ...
    parser.add_argument('--games_path', type=str, default='data/games.csv',
                        help='Path to the games data CSV file')
    parser.add_argument('--champion_info_path', type=str, default='data/champion_info.json',
                        help='Path to the champion info JSON file')
    parser.add_argument('--test_size', type=float, default=0.2,
                        help='Proportion of data to use for testing')
    parser.add_argument('--random_state', type=int, default=42,
                        help='Random seed for reproducibility')
    parser.add_argument('--model_name', type=str, default='draft_predictor',
    ...
    data_processor = DataProcessor(args.games_path, args.champion_info_path)
